...
>[!NOTE]
>The account that you specify for the tester account must already exist on the device. For specific steps to create the tester account click [here](https://docs.microsoft.com/en-us/education/windows/take-a-test-single-pc#set-up-a-dedicated-test-account).
